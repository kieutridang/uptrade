...
class FiltSearchCat extends React.Component {
  render () {
    return (
        ...
        <div className='container'>
          <div className='row'>
            ...
            <div className='col-md-6 buttons-row nopadding'>
              ...
              <Button variant='contained' style={styles.redButton} className='btn-w-sm'><Icon style={styles.smallIcon}>folder</Icon>Categories</Button>
