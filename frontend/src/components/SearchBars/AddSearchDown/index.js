        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-8 buttons-row nopadding'>
              <Button variant='contained' id='add-button' style={styles.greenButton} className='btn-w-sm' onClick={addHandler} data-cy='add-client'><Icon style={styles.smallIcon}>add</Icon>New</Button>
