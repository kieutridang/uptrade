...
const Form = (props) => {
  const { handleSubmit, openCreateSupplierMode, errors, setFieldValue, values } = props
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className={`${openCreateSupplierMode ? 'text-center' : ''} mb-5 mt-2`}>
        <Button type='submit' typeClass='green-button'>Create supplier</Button>
      </div>
    </form>
  )
}
