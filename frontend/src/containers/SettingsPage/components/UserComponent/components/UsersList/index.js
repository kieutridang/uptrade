...
import UserBarCard from '../../../../../../components/InlineBars/UserBarCard/index'
                    ...
                    <Card className={classes.card}>
                      ...
                      <CardActions className={classes.profileaction}>
                        <UserBarCard
                          ...
                          editHandler={() => {
                            openEditProfileFormHandler(profile._id)
                          }}
                          sendMailHandler={() => {
                            sendResetPasswordHandler(profile.email)
                          }}
                          // deleteUserHandler={() => {
                          //   deleteUserInCompanyHandler(profile)
                          // }}
                        />
                      </CardActions>
                    </Card>
