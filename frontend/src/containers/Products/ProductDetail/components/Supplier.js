...
class Supplier extends React.Component {
  ...
  render () {
    ...
    return (
      <form id='product-detail-supplier-form' onSubmit={handleSubmit}>
              ...
              <div className='box box-default'>
                <div className='box-header'>
                  ...
                  <ToggleEditSaveAddInline
                    ...
                    editClickHandler={() =>
                      handleToggleActiveEdit &&
                      handleToggleActiveEdit('activeSupplierEdit')
                    }
                    saveDisabled={isSubmitting || !dirty}
                    addClickHandler={this.addNewSupplier}
                  />
                </div>
                        ...
                        <div>
                          {values.supplier &&
                            values.supplier.map((item, index) => {
                              let supplier = suppliers.find((supplier) => supplier._id === item._id)
                              return (
                                <div className='row' key={index}>
                                  ...
                                  <div className='col-sm-4 col-md-2'>
                                    <FieldTextOnly
                                      ...
                                      className='input'
                                      placeholder='Status'
                                      value={supplier && supplier._company && supplier._company.about && supplier._company.about.status}
                                    />
                                  </div>
                                  <div className='col-sm-4 col-md-2'>
                                    <Field
